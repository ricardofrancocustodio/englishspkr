                        ...
                        <div class="card">
                          ...
                          <div class="card-body">
                            ...
                            <form action="/instruction" method="PATCH">
                                @csrf
                               <input type="hidden" name="id_testtype" value="1"><br>
                               <button type="submit" class="btn btn-info" style="width:100%;">Start Test</button>
                      ...
                      <div class="col-md-6">
                        <div class="card">
                          ...
                          <div class="card-body clearfix">
                            ...
                            <form action="/instruction" method="PATCH">
                                @csrf
                                <input type="hidden" name="id_testtype" value="2"><br>
                                <button type="submit" class="btn btn-info" style="width:100%;">Start Test</button>
                                <!-- <a class="btn btn-success btn-md" href="#" role="button" id="submitForm" style="width:100%;">Start Test</a> -->
                            </form>
                          </div>
